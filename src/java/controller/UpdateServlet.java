...
import bean.Project;
import static controller.UpdateServlet.num;
...
public class UpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          proj_dao.updateProject(project);
          stud_dao.updateStudent(stud,proj,lect);
          ...
          request.setAttribute("proj", project);
           ...
           RequestDispatcher view = request.getRequestDispatcher("/RegisSuccess.jsp");
           view.forward(request,response);
        }
